...
urlpatterns = [
    ...
    url(r'^products/detail/(?P<pk>\d+)/$',
        adminapp.ProductDetailView.as_view(), name='products_detail_view'),
    ...
    url(r'^contacts/update/(?P<pk>\d+)/$',
        adminapp.ContactUpdateView.as_view(), name='contact_update'),
    url(r'^contacts/delete/(?P<pk>\d+)/$',
        adminapp.ContactDeleteView.as_view(), name='contact_delete'),

    url(r'^orders/read/', adminapp.orders, name='orders'),
